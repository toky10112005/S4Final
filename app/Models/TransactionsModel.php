...
class TransactionsModel extends Model
{
    ...
    protected $allowedFields = ['id_type_operation', 'id_expediteur', 'id_destinataire','id_operateur_cible', 'montant','promotion', 'frais', 'frais_retrait_prepaye', 'date_transaction'];
